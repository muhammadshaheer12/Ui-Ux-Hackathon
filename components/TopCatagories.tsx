...
const TopCatagories = () => {
  return (
    <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div className="flex flex-col items-center ">
            ...
            <div className="text-center flex flex-col items-center gap-3 text-[#151875]">
              <h1 className="text-lg font-bold">Mini LCW Chair</h1>
      ...
      <div className="bg-[url('/images/bg2.png')] bg-cover bg-center w-screen h-[20rem] flex flex-col items-center justify-center">
        <div className="md:w-[35vw]  flex flex-col items-center gap-6">
          <h1 className="text-3xl text-center">
            Get Leatest Update By Subscribe 0ur Newsletter
          </h1>
      ...
      <div className="bg-[url('/images/image.png')] bg-cover bg-center w-screen h-[10rem] flex flex-col items-center justify-center"></div>
    </div>
  );
};
